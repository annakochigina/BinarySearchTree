...
begin
    ...
    case nform5 of
      1: begin
        LbName.Caption := 'Сбалансированность бинарного дерева';
      ...
      2: begin
        LbName.Caption := 'Свойство бинарного дерева поиска';
        Label1.Caption := 'Укажите вершины, в которых нарушается свойство упорядоченности бинарного дерева';
        AddButton;
        ButtonFalse;
        RandomTree (number_tree);
        count_nodes := 1;
